...
public class GhprbCause extends Cause{
    ...
    public GhprbCause(String commit, int pullID, boolean merged, String targetBranch, String sourceBranch, String authorEmail, String authorName, String title, URL url){
		this.commit = commit;
		this.pullID = pullID;
		this.merged = merged;
